...
def PSLDH_Algo(code_length):
    ...
    optimizer_hash = optim.SGD([{'params': hash_model.features.parameters(), 'lr': learning_rate * 0.1}, {'params': hash_model.classifier.parameters(), 'lr': learning_rate}], weight_decay=weight_decay)
